...
if __name__ == "__main__":
    ...
    parser.add_argument("--method", type=str, default='lkh', choices=["lkh", ])
    parser.add_argument("--datasets", nargs='+', default=["../../data/CVRP/Size/cvrp100_uniform.pkl", ], help="Filename of the dataset(s) to evaluate")
